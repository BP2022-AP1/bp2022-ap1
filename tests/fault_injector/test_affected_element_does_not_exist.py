...
class TestAffectedElementDoesNotExist:
    ...
    @pytest.fixture
    def fault(self, fault_configuration: FaultConfiguration, logger: Logger, simulation_object_updater: SimulationObjectUpdatingComponent, interlocking: IInterlockingDisruptor, fault_type: Fault):
        return fault_type(configuration=fault_configuration, logger=logger, simulation_object_updater=simulation_object_updater, interlocking=interlocking)
