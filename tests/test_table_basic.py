...
class TestFailingDict:
    ...
    def test_create(self, table_class, object_as_dict):
    ...
    def test_deserialization(self, table_class, object_as_dict):
...
class TestCorrectFilledDict:
    ...
    def test_serialization(self, table_class, object_as_dict):
    ...
    def test_deserialization_full_dict(self, table_class, object_as_dict):
