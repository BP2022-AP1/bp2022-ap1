...
class Logger:
    ...
    def spawn_train(self, train_id: int):
        """
    ...
    def arrival_train(self, train_id: int, station_id: int):
        """
    ...
    def departure_train(self, train_id: int, station_id: int):
        """
    ...
    def create_fahrstrasse(self, fahrstrasse: any):
        """
    ...
    def remove_fahrstrasse(self, fahrstrasse: any):
        """
    ...
    def set_signal(self, signal_id: int, state_before: int, state_after: int):
        """
    ...
    def remove_fault(self, injection_id: int):
        """
